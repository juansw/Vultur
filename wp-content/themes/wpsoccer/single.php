...
<section id="main">
   ...
   <?php get_template_part('lib/sub-header')?>
    ...
    <div class="container">
        <div class="row">
            <div id="content" class="site-content col-md-8" role="main" style="margin-bottom: 45px!important"> 
                        ...
                        <?php get_template_part( 'post-format/content', get_post_format() ); ?>
                         ...
                         <?php if ( isset($themeum_options['post-nav-en']) && $themeum_options['post-nav-en'] ) { ?>
                            <div class="clearfix post-navigation">
                                <?php previous_post_link('<span class="previous-post pull-left">%link</span>','<i class="fa fa-long-arrow-left"></i> '.__("Anterior","themeum")); ?>
                                <?php next_post_link('<span class="next-post pull-right">%link</span>',__("Siguiente","themeum").' <i class="fa fa-long-arrow-right"></i>'); ?>
                            </div> <!-- .post-navigation -->
                        <?php } ?>
