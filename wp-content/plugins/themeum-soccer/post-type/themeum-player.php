...
function themeum_post_type_player(){
	$labels = array(
		'name'                	=> _x( 'Riders', 'Player', 'themeum-soccer' ),
		'singular_name'       	=> _x( 'Riders', 'Player', 'themeum-soccer' ),
		'menu_name'           	=> __( 'Riders', 'themeum-soccer' ),
		'parent_item_colon'   	=> __( 'Parent Rider:', 'themeum-soccer' ),
...
function themeum_soccer_update_message( $messages ){
	...
	$message['player'] = array(
		0 => '',
		1 => sprintf( __('Player updated. <a href="%s">View Rider</a>', 'themeum-soccer' ), esc_url( get_permalink($post_ID) ) ),
		...
		8 => sprintf( __('Rider submitted. <a target="_blank" href="%s">Preview Player</a>', 'themeum-soccer' ), esc_url( add_query_arg( 'preview', 'true', get_permalink($post_ID) ) ) ),
